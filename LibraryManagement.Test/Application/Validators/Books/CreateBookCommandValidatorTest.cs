...
namespace LibraryManagement.Test.Application.Validators.Books
{
    public class CreateBookCommandValidatorTest
    {
        ...
        public void Should_Validate_Create_Books_Command_Validators_Test(CreateBookCommand command, List<string> expectedNotifications, bool isValid)
        {
            // Arrange
        ...
        public static IEnumerable<object[]> ValidationCasesCreate()
        {
            ...
            [
                [
                    new CreateBookCommand { Title = "Title", Author = "Author", Isbn = "ISBN000010", PublicationYear = 2001 },
                    new List<string> { },
                    true
                ],
                [
                    new CreateBookCommand { Title = string.Empty, Author = string.Empty, Isbn = string.Empty, PublicationYear = -2024 },
                ...
                [
                    new CreateBookCommand { Title = "Ti", Author = "A", Isbn = "ISBN000000013", PublicationYear = 2001 },
                ...
                [
                    new CreateBookCommand { Title = "Title", Author = "Author", Isbn = "ISBN000010", PublicationYear = 2050 },
