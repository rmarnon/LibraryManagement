...
namespace LibraryManagement.Test.Application.Validators.Users
{
    public class CreateUserCommandValidatorTest
    {
        ...
        public void Should_Validate_Create_Users_Command_Validators_Test(CreateUserCommand command, List<string> expectedNotifications, bool isValid)
        {
            // Arrange
        ...
        public static IEnumerable<object[]> ValidationCasesCreate()
        {
            ...
            [
                [
                    new CreateUserCommand { Email = "email@gmail.com", Name = "Name", Password = "P@assword0123" },
                    new List<string> { },
                    true
                ],
                [
                    new CreateUserCommand { Email = string.Empty, Name = string.Empty, Password = string.Empty },
                    new List<string> { "Name must not to be null", "Email must not to be null", "Password is required" },
                    false
                ],
                [
                    new CreateUserCommand { Email = "InvalidEmail", Name = "N", Password = "P@assword0123" },
                    new List<string> { "Name must be between 2 and 50 characters", "Invalid email adress" },
                    false
                ],
                [
                    new CreateUserCommand { Email = "a@g.c", Name = "Name", Password = "P@InvalidPassword0123" },
